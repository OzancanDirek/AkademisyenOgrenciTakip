...
namespace OgrenciOgretmenProje.Entity
{
    using System;
    ...
    public partial class OgrenciSinavEntities : DbContext
    {
        ...
        public virtual ObjectResult<NotlarList_Result> NotlarList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<NotlarList_Result>("NotlarList");
        }
    
        public virtual ObjectResult<NotlarList1_Result> NotlarList1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<NotlarList1_Result>("NotlarList1");
        }
    }
}
